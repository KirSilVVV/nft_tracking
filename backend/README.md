# NFT Analytics App - Mutant Ape Yacht Club

Real-time blockchain analytics and monitoring application for Mutant Ape Yacht Club (MAYC) NFT collection on Ethereum.
